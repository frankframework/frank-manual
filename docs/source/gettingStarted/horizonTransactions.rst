...
This last requirement can be implemented very easily. In file ``Configuration.xml``, please update the ``<Pipeline>`` tag by inserting the attribute ``transactionAttribute="RequiresNew"``. Here is the update:
