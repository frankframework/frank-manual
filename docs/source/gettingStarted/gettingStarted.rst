...
This chapter can be studied in two ways. First, it is a tutorial. There are instructions that you can follow to get hands-on experience with the Frank!Framework. You will use Frank!Runner, to be found at https://github.com/ibissource/frank-runner. Second you can just read the text on your laptop or even your telephone.

If you want, you can download the solutions. There are separate download links for the :download:`configuration <../downloads/configurations/NewHorizons.zip>` and the :download:`Larva tests <../downloads/tests/NewHorizons.zip>`.
