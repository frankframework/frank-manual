...
The Java source code of the Frank!Framework can be found at https://github.com/ibissource/iaf. You can also find release notes here, see https://github.com/ibissource/iaf/releases.
