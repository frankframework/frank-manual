...
This chapter presents the Frank!Console, the graphical user interface that will support you. The Frank!Console offers you a dashboard that shows the status of all Frank configurations. You can use the Frank!Console to track errors. You also use the Frank!Console to load Frank configurations, or new versions of Frank configurations, into the Frank!Framework. Next, you learn how to schedule tasks to be executed periodically. Finally, you learn how to control disk space usage.
