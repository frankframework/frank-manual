...
if __name__ == "__main__":
    ...
    class TestSortDirectories(unittest.TestCase):
        def test_happy(self):
            root = GitDirectoryTree("TutorialSteps/testdataSortDirectories")
        ...
        def test_when_first_dir_has_predecessor_then_error(self):
            root = GitDirectoryTree("TutorialSteps/testDataSortDirectoriesFirstHasPredecessor")
            theDirectories = root.getSubdirs()
            result, error = sortDirectories(theDirectories)
        ...
        def test_when_predecessor_references_forward_then_error(self):
            root = GitDirectoryTree("TutorialSteps/testDataSortDirectoriesForwardPredecessor")
            theDirectories = root.getSubdirs()
            result, error = sortDirectories(theDirectories)
